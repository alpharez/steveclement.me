...
export default function Jan2022() {
  return (
    <Layout>
      ...
      <p>
      So I get a power supply and plug everything up.  Same issue.
      </p>
      <p>
      ...
      <p>Bad power supply, or 650 Watts isn't enough all of a sudden.  750 Watt Power Supply seems to work fine now.
      </p>
     </Layout>
  )
}⏎
